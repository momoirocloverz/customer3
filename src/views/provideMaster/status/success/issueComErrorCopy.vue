<template>
    <div class="issueComErrCon">
        <div class="topPart">
            <div class="flexCon">                
                <el-input v-model="userName" size="small" placeholder="人员姓名" class="limitInput" clearable><el-button slot="append" icon="el-icon-search"></el-button></el-input>
            </div>
            <div>
