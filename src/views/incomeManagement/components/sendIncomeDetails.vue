<template>
    <div class="send-income-detail" v-loading="loading" element-loading-text="正在请求中...">
        <div class="topCon mt15">
            <div class="">
                ...
                <el-select size="small" class="lockWidth mr20" v-model="params.taskId" placeholder="任务名称">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getTaskList(){
                this.options2 = [{label: '不限', value: -1}]
            ...
            getList() {
                ...
                this.ApiLists.getAlready(params).then(res => {
                    if (res.respCode === 0) {
